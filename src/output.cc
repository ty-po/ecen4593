...
void output(Config params, Data data) {
  ...
  cout << setw(2)<<"" << "Execute time = " << right << setw(12) << data.totalCycles << ";  Total refs = " << data.totalRefs << endl;
  ...
  cout << setw(4)<<"" << "Inst.  = " << right << setw(11) << data.instructionCycles << "    [" << setw(4) << fixed << setprecision(1) << (float)data.instructionCycles/data.totalCycles * 100 << "%]" << endl;
